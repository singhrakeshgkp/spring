package com.esstore.order.advice;
...
import com.esstore.order.exception.OrderErrorResponse;

@ControllerAdvice
public class OrderServficeErrorHandlerAdvice {
	...
	public ResponseEntity<Object> entityExitException(EntityExistsException ex, WebRequest webRequest){
		...
		OrderErrorResponse errorResponse = new OrderErrorResponse("order-ms-001", ex.getMessage(), new Date());
